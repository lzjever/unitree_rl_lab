...
UNITREE_MODEL_DIR = os.environ.get("UNITREE_MODEL_DIR", str(_WORKSPACE_ROOT / "third_party" / "unitree_model"))
UNITREE_ROS_DIR = os.environ.get("UNITREE_ROS_DIR", str(_WORKSPACE_ROOT / "third_party" / "unitree_ros" / "unitree_ros"))
